...
def coregister_maps_to_mni(warped_directory, base_dir, mnitpl_fp, doit=False):
    rdwinh = [e for e in glob(osp.join(warped_directory, 'wr*.nii'))]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--doit', help='Run it without prompting', action='store_true')
    ...
    coregister_maps_to_mni(opts.warped_directory, opts.target_directory, template, opts.doit)
